...
class Squares(Problem):
    ...
    def h(self, node):
        ...
        raz1 = abs(pos_1[0] - 0) + abs(pos_1[1] - 4)
        raz2 = abs(pos_2[0] - 1) + abs(pos_2[1] - 3)
        raz3 = abs(pos_3[0] - 2) + abs(pos_3[1] - 2)
        raz4 = abs(pos_4[0] - 3) + abs(pos_4[1] - 1)
        raz5 = abs(pos_4[0] - 4) + abs(pos_5[1] - 0)

        return raz1 + raz2 + raz3 + raz4 + raz5
        ...
